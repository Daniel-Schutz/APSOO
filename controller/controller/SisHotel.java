...
public class SisHotel {
    ...
    public String registrarReserva(Date dataEntrada, int diasEstadia, String tipoPagamento, String situacao,
            String pessoaCPF) {
    ...
    // String mensagem = Hospedagem.realizarCheckOut(codigo, this.hospedagemDAO,
    // this.reservaQuartoDAO, this.quartoDAO);
    // return mensagem;
