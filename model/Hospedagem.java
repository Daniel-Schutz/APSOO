...
public class Hospedagem {
    ...
    //         hospedagem.statusCheckOut = true; //temos q buscar uma hospedagem antes para depois realizar a atualização dessa, temos que corrigir BuscarHospedagem no hospedagem dao
